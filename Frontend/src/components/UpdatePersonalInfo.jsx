...
const UpdatePersonalInfo = () => {
    ...
    <>
      ...
      <div className="container my-5">
        ...
        <form onSubmit={handleSubmit}>
          {/* Pre-filled and readonly fields */}
          <div className="mb-3">
            <label>Email</label>
  ...
  <div className="col-md-6 mb-3">
    ...
    <input name="classroll" className="form-control" value={formData.classroll} onChange={handleChange} required pattern="\d{12}" title="Enter 12-digit Aadhaar number" />
  </div>
